...
public class SpotifyController {
    ...
    @PostMapping("/add-album")           //@RequestParam("artistName")
    public String createAlbum(@RequestParam(name = "title") String title,@RequestParam("artistName") String artistName){
        //If the artist does not exist, first create an artist with given name    //@RequestParam("artistName")
    ...
    public String createPlaylistOnLength(@RequestParam("mobile")String mobile,@RequestParam("title")String title,
                                         @RequestParam("length")int length) throws Exception{
    ...
    public String createPlaylistOnName(@RequestParam("mobile")String mobile,@RequestParam("title")String title,
